...
public class CuisineList extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		newSelectedCuisines = new String[] {};
		...
		for(String option : previouslySelectedCuisines) {
			...
			lv.setItemChecked(cuisines.getPosition(option), true);
		}
	...
	public void saveFilter(View view) {
		...
		newSelectedCuisines = selectedCuisines.toArray(newSelectedCuisines);
		Arrays.sort(newSelectedCuisines);
		data.putExtra(FastFood.CURRENT_CUISINE_CHOICES, newSelectedCuisines);
